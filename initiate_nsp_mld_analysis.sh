...
python df-analyze.py --df ../ctg_data_processors/data/output/processed_data_ctg_fhr_all.csv --target CLASS --mode classify --classifiers knn lgbm rf lr sgd dummy --regressors knn lgbm rf elastic sgd dummy --feat-select filter embed wrap --redundant-wrapper-selection --embed-select lgbm linear --wrapper-select step-up --wrapper-model linear --norm robust --nan median --filter-method assoc pred --filter-assoc-cont-classify mut_info --filter-assoc-cat-classify mut_info --filter-assoc-cont-regress mut_info --filter-assoc-cat-regress mut_info --filter-pred-regress mae --filter-pred-classify acc --htune-trials 50 --htune-cls-metric acc --htune-reg-metric mae --test-val-size 0.4 --outdir ./df_analyze_all_fhr_results
...
python df-analyze.py --df ../ctg_data_processors/data/output/processed_data_ctg_nsp_heart.csv --target NSP --mode classify --classifiers knn lgbm rf lr sgd dummy --regressors knn lgbm rf elastic sgd dummy --feat-select filter embed wrap --redundant-wrapper-selection --embed-select lgbm linear --wrapper-select step-up --wrapper-model linear --norm robust --nan median --filter-method assoc pred --filter-assoc-cont-classify mut_info --filter-assoc-cat-classify mut_info --filter-assoc-cont-regress mut_info --filter-assoc-cat-regress mut_info --filter-pred-regress mae --filter-pred-classify acc --htune-trials 50 --htune-cls-metric acc --htune-reg-metric mae --test-val-size 0.4 --outdir ./df_analyze_nsp_heart_rate_results
...
python df-analyze.py --df ../ctg_data_processors/data/output/processed_data_ctg_fhr_heart.csv --target CLASS --mode classify --classifiers knn lgbm rf lr sgd dummy --regressors knn lgbm rf elastic sgd dummy --feat-select filter embed wrap --redundant-wrapper-selection --embed-select lgbm linear --wrapper-select step-up --wrapper-model linear --norm robust --nan median --filter-method assoc pred --filter-assoc-cont-classify mut_info --filter-assoc-cat-classify mut_info --filter-assoc-cont-regress mut_info --filter-assoc-cat-regress mut_info --filter-pred-regress mae --filter-pred-classify acc --htune-trials 50 --htune-cls-metric acc --htune-reg-metric mae --test-val-size 0.4 --outdir ./df_analyze_fhr_heart_rate_results
...
python df-analyze.py --df ../ctg_data_processors/data/output/processed_data_ctg_nsp_no_histogram.csv --target NSP --mode classify --classifiers knn lgbm rf lr sgd dummy --regressors knn lgbm rf elastic sgd dummy --feat-select filter embed wrap --redundant-wrapper-selection --embed-select lgbm linear --wrapper-select step-up --wrapper-model linear --norm robust --nan median --filter-method assoc pred --filter-assoc-cont-classify mut_info --filter-assoc-cat-classify mut_info --filter-assoc-cont-regress mut_info --filter-assoc-cat-regress mut_info --filter-pred-regress mae --filter-pred-classify acc --htune-trials 50 --htune-cls-metric acc --htune-reg-metric mae --test-val-size 0.4 --outdir ./df_analyze_nsp_no_histogram_results
...
python df-analyze.py --df ../ctg_data_processors/data/output/processed_data_ctg_fhr_no_histogram.csv --target CLASS --mode classify --classifiers knn lgbm rf lr sgd dummy --regressors knn lgbm rf elastic sgd dummy --feat-select filter embed wrap --redundant-wrapper-selection --embed-select lgbm linear --wrapper-select step-up --wrapper-model linear --norm robust --nan median --filter-method assoc pred --filter-assoc-cont-classify mut_info --filter-assoc-cat-classify mut_info --filter-assoc-cont-regress mut_info --filter-assoc-cat-regress mut_info --filter-pred-regress mae --filter-pred-classify acc --htune-trials 50 --htune-cls-metric acc --htune-reg-metric mae --test-val-size 0.4 --outdir ./df_analyze_fhr_no_histogram_results
...
python df-analyze.py --df ../ctg_data_processors/data/output/processed_data_ctg_nsp_no_fluc.csv --target NSP --mode classify --classifiers knn lgbm rf lr sgd dummy --regressors knn lgbm rf elastic sgd dummy --feat-select filter embed wrap --redundant-wrapper-selection --embed-select lgbm linear --wrapper-select step-up --wrapper-model linear --norm robust --nan median --filter-method assoc pred --filter-assoc-cont-classify mut_info --filter-assoc-cat-classify mut_info --filter-assoc-cont-regress mut_info --filter-assoc-cat-regress mut_info --filter-pred-regress mae --filter-pred-classify acc --htune-trials 50 --htune-cls-metric acc --htune-reg-metric mae --test-val-size 0.4 --outdir ./df_analyze_nsp_no_fluc_results
...
python df-analyze.py --df ../ctg_data_processors/data/output/processed_data_ctg_fhr_no_fluc.csv --target CLASS --mode classify --classifiers knn lgbm rf lr sgd dummy --regressors knn lgbm rf elastic sgd dummy --feat-select filter embed wrap --redundant-wrapper-selection --embed-select lgbm linear --wrapper-select step-up --wrapper-model linear --norm robust --nan median --filter-method assoc pred --filter-assoc-cont-classify mut_info --filter-assoc-cat-classify mut_info --filter-assoc-cont-regress mut_info --filter-assoc-cat-regress mut_info --filter-pred-regress mae --filter-pred-classify acc --htune-trials 50 --htune-cls-metric acc --htune-reg-metric mae --test-val-size 0.4 --outdir ./df_analyze_fhr_no_fluc_results